  ...
  return (
    <div className='flex flex-wrap gap-2 mb-4'>
      <Button
        ...
        className={
          initialFilter === 'all'
            ...
            : 'border-border/60 hover:border-violet-300 dark:hover:border-violet-700 hover:text-violet-600 dark:hover:text-violet-400'
        }
      >
        All URLs
      </Button>
      ...
      <Button
        ...
        className={
          initialFilter === 'flagged'
            ...
            : 'border-border/60 hover:border-amber-300 dark:hover:border-amber-700 hover:text-amber-600 dark:hover:text-amber-400'
        }
      >
        <FlagIcon className='size-4 mr-1.5' />
        All Flagged
      </Button>
      ...
      <Button
        ...
        className={
          initialFilter === 'security'
            ...
            : 'border-border/60 hover:border-red-300 dark:hover:border-red-700 hover:text-red-600 dark:hover:text-red-400'
        }
      >
        <ShieldIcon className='size-4 mr-1.5' />
        Security Risks
      </Button>
      ...
      <Button
        ...
        className={
          initialFilter === 'inappropriate'
            ...
            : 'border-border/60 hover:border-orange-300 dark:hover:border-orange-700 hover:text-orange-600 dark:hover:text-orange-400'
        }
      >
      ...
      <Button
        ...
        className={
          initialFilter === 'other'
            ? 'bg-yellow-100 dark:bg-yellow-900/30 text-yellow-700 dark:text-yellow-300 border-yellow-200 dark:border-yellow-800 hover:bg-yellow-200 dark:hover:bg-yellow-900/50'
            : 'border-border/60 hover:border-yellow-300 dark:hover:border-yellow-700 hover:text-yellow-600 dark:hover:text-yellow-400'
        }
      >
